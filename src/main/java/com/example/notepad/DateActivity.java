...
public class DateActivity extends AlertDialog implements OnClickListener, OnDateChangedListener {
    ...
    public DateActivity(Context context, OnDateSetListener callBack, int year, int monthOfYear, int dayOfMonth) {
        this(context, 0, callBack, year, monthOfYear, dayOfMonth);
    }

    public DateActivity(Context context, int theme, OnDateSetListener callBack, int year, int monthOfYear,
                        int dayOfMonth) {
